...
1    debian_chroot=$(cat /etc/debian_chroot)
fi
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;31m\]\u@\h\[\033[00m\]: \[\033[01;34m\]\W $(git_prompt) \[\033[00m\]>_ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u at \h in \W $(git_prompt) >_ '
fi
